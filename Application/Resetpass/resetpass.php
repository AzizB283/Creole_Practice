...
<html lang="en">
    <head>
        ...
        <script src="../jQuery/reset.js"></script>
    ...
    <body>
        ...
        <form action="" class = "container border border-secondary border-3 rounded-3 w-50 text-center d-flex flex-column justify-content-center cmxform" method="post" id="resetForm">
            ...
            <div class="mb-3">
                <label for="cpassword" class="col-form-label">Enter New Password :</label>
                <div class="col-sm-10 mx-auto">
                    <input type="password" class="form-control error" id="cpassword" name="password" minlength="6" maxlength="10" required>
                </div>
            </div>

            <div class="mb-3">
                <button class="submit btn btn-primary" id="submit">Set Password</button>
            </div><br>
